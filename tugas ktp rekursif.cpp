...
// Fungsi input rekursif
void inputKTP(KTP &ktp, bool ulang = false) {
    if (!ulang) {
        cout << "Masukkan NIK: ";
        cin >> ktp.nik;
        clearInputBuffer();
    ...
    char ulangi;
    cout << "\nApakah ingin mengulangi input data? (y/n): ";
    cin >> ulangi;
    clearInputBuffer();
...
void editKTP(KTP &ktp) {
    ...
    switch (pilihan) {
        case 1:
		 cout << "Nama baru: "; getline(cin, ktp.nama); break;
        case 2:
		 cout << "Tempat/Tgl Lahir baru: "; getline(cin, ktp.tempat_tgl_lahir); break;
        case 3:
		 cout << "Jenis Kelamin baru: "; getline(cin, ktp.jenis_kelamin); break;
        case 4:
		 cout << "Golongan Darah baru (A/B/AB/O): "; cin >> ktp.gol_darah; clearInputBuffer(); break;
        case 5:
		 cout << "Alamat baru: "; getline(cin, ktp.alamat); break;
        case 6:
		 cout << "RT/RW baru: "; getline(cin, ktp.rt_rw); break;
        case 7:
		 cout << "Kelurahan/Desa baru: "; getline(cin, ktp.kel_desa); break;
        case 8:
		 cout << "Kecamatan baru: "; getline(cin, ktp.kecamatan); break;
        case 9:
		 cout << "Agama baru: "; getline(cin, ktp.agama); break;
        case 10:
		 cout << "Status Perkawinan baru: "; getline(cin, ktp.status_perkawinan); break;
        case 11:
		 cout << "Pekerjaan baru: "; getline(cin, ktp.pekerjaan); break;
        case 12:
		 cout << "Kewarganegaraan baru: "; getline(cin, ktp.kewarganegaraan); break;
        case 13:
		 cout << "Berlaku Hingga baru: "; getline(cin, ktp.berlaku_hingga); break;
        case 0: 
			cout << "Selesai mengedit data.\n"; return;
        default:
		 cout << "Pilihan tidak valid.\n"; break;
    }

    // Rekursi untuk edit lagi
    editKTP(ktp);
}
